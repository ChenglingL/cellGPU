#ifndef autocorrelatorVector_H
#define autocorrelatorVector_H

#include "std_include.h"
#include "functions.h"

/*! \file autocorrelatorVector.h */
...
*/
class autocorrelatorVector
    {
    public:
        //! The basic constructor
        autocorrelatorVector(int pp=16, int mm=2, double deltaT = 1.0);
        //! Add a new data point to the correlator
        void add(double2 w, int k=0);
    ...
    protected:
        ...
        //!The actual values accumulating in each correlator (Ai)
        vector<double2> accumulator;
