...
/*! \file GlassyDynModelDatabase.cpp */

GlassyDynModelDatabase::GlassyDynModelDatabase(int np, string fn, NcFile::FileMode mode)
...
void GlassyDynModelDatabase::SetDimVar()
    {
    //Set the dimensions
...
void GlassyDynModelDatabase::writeState(STATE c, double time, int rec)
    {
...
void GlassyDynModelDatabase::readState(STATE c, int rec,bool geometry)
    {
