...
int main(int argc, char*argv[])
{
    ...
    sprintf(loaddataname,"%sglassyDynamics_N%i_p%.4f_T%.8f_waitingTime%.6f_idx%i.nc",savefolder,numpts,p0,T,waitingtime,recordIndex);
    sprintf(saveDataName,"%sSISF_N%i_p%.4f_T%.8f_waitingTime%.6f_idx%i.nc",savefolder,numpts,p0,T,waitingtime,recordIndex);
