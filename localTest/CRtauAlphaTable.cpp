...
/*!
This is for CRoverlap and cage-relative SISF calculation for the data generated by taualpha.cpp
*/
...
int main(int argc, char*argv[])
{
    ...
    sprintf(CRoverlapDataName,"%stimeCRoverlap_N%i_p%.4f_T%.8f_waitingTime%.0f_idx%i.nc",savefolder,numpts,p0,T,waitingtime,recordIndex);
