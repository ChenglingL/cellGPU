...
/*!
This is for MSD for the data generated by taualpha.cpp. tHIS IS SPEFCIFICALLY FOR PRODUCTION RUNS in delta.
*/
...
int main(int argc, char*argv[])
{
    ...
    sprintf(saveDataName,"%stimeMSD_N%i_p%.4f_T%.8f_waitingTime%.0f_idx%i.nc",savefolder,numpts,p0,T,waitingtime,recordIndex);
    ...
    for(int rec=0;rec<fluidConfigurations.GetNumRecs();rec++){
        ...
        SISFCRSISF->writeValues(voronoiModel->currentTime, dynFeat.computeMSD(voronoiModel->returnPositions()));        
    };   
