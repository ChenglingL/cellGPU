...
/*!
This is to test if the rectangular box works in cellGPU..
*/
...
int main(int argc, char*argv[])
{
    ...
    while((c=getopt(argc,argv,"n:g:m:s:r:a:i:v:b:x:y:z:p:t:e:")) != -1)
        switch(c)
        {
            ...
            case 'x': newLx = atof(optarg); break;
            case 'y': newLy = atof(optarg); break;
    ...
    char dataname[256];
    sprintf(dataname,"/home/chengling/Research/Project/Cell/AnalyticalG/data/N%i/rectangularTest/recTest_N%i_p%.3f_T%.8f_boxX_%.6f_boxY_%.6f_%i.nc",numpts,numpts,p0,T,newLx,newLy,id);
    ...
    voronoiModel->setRectangularUnitCell(newLx,newLy);
    nvt->setT(T);
...
//    cudaProfilerStart();
    ...
    for(long long int ii = 0; ii < tSteps; ++ii)
        ...
        if (ii % 100 == 0){
            ...
            cout<<"1stD pure shear: "<<voronoiModel->getdEdepsilon()<<"; 2ndD pure shear: "<<voronoiModel->getd2Edepsilondepsilon()<<endl;
        }
