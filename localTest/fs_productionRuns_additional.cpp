...
/*!
This is for cage-relative SISF calculation for the data generated by taualpha.cpp for additional data for helen
*/
...
int main(int argc, char*argv[])
{
    ...
    sprintf(loadfolder,"/home/chengling/Research/Project/Cell/glassyDynamics/N%i/additional/p%.3f/",numpts,p0);
    ...
    sprintf(saveDataName,"%stimeCRSISF_N%i_p%.4f_T%.8f_k%.3f_waitingTime%.0f_idx%i.nc",savefolder,numpts,p0,T,ks,waitingtime,recordIndex);
    ...
    for(int rec=0;rec<fluidConfigurations.GetNumRecs();rec++){
        ...
        SISFCRSISF->writeValues(time, dynFeat.computeCageRelativeSISF(voronoiModel->returnPositions(),ks));        
    };   
