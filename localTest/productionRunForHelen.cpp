...
int main(int argc, char*argv[])
{
    ...
    sprintf(saveDirName, "/home/chengling/Research/Project/Cell/glassyDynamics/systemsizeTrajectory/N%i/",numpts);
    sprintf(dataname,"%snvt_N%i_p%.4f_T%.8f_waitingTime%.0f_idx%i.nc",saveDirName,numpts,p0,T,floor(equilibrationTimesteps*dt),recordIndex);
    ...
    shared_ptr<nvtModelDatabase> nvtdat=make_shared<nvtModelDatabase>(numpts,dataname,NcFile::Replace);
    lewriter.addDatabase(nvtdat,0);
