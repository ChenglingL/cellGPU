...
int main(int argc, char*argv[])
{
    ...
    alpha = sizeRatio * sizeRatio * sizeRatio;
    ...
    sprintf(energyDataname,"%smeanVertexForce&Energy_N%i_p%.3f_KA%.4f_sizeRatio%.3f_fraction%.3f.nc",saveDirName,numpts,p0,KA,sizeRatio,fraction);
