...
/*!
This is used to generated statistics for areas and primeters at different T. Data sare saved in log-spaced time.
*/
...
int main(int argc, char*argv[])
{
    ...
    char dataname[256];
    sprintf(dataname,"/home/chengling/Research/Project/Cell/AnalyticalG/data/N%i/AreaPriStat/nvt_AP_N%i_p%.3f_T%.8f_%i.nc",numpts,numpts,p0,T,id);
