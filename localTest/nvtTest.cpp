...
/*!
THis is to test the modified nvt Nose-Hoover thermostats and record the energy stats.
...
int main(int argc, char*argv[])
{
    ...
    sprintf(potentialEnergyname,"%stimePotentialEnergy_N%i_p%.4f_T%.8f_M%i.nc",saveDirName,numpts,p0,T,Nchain);
    shared_ptr<twoValuesDatabase> potentialEnergydat=make_shared<twoValuesDatabase>(potentialEnergyname,NcFile::Replace);
    sprintf(kineticEnergyname,"%stimeKineticEnergy_N%i_p%.4f_T%.8f_M%i.nc",saveDirName,numpts,p0,T,Nchain);
