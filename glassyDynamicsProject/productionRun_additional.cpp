...
int main(int argc, char*argv[])
{
    ...
    cout<<" Additional production runs"<<endl;
    ...
    sprintf(saveDirName, "/scratch/bbtm/cli6/glassyDynamics/data/N%i/additional/p%.3f/",numpts,p0);
    if (fs::exists(saveDirName) && fs::is_directory(saveDirName)) {
        printf("Save directory exists: %s\n", saveDirName);
    } else {
