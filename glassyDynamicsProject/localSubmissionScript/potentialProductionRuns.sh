...
for recordIdx in ${records[@]}; do
    for i in ${!temperatures[@]}; do
        ...
        /home/chengling/Research/Project/Cell/AnalyticalG/cellGPU/localTest/executable/potentialEnergyProductionRuns.out -n ${number} -p ${p} -v ${temp} -t ${tauEstimate[$i]} -r ${recordIdx} -g -1
    done
done
# nRelaxation=10
