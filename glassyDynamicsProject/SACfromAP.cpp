...
productionRuns and record SAC from contribution A and P. This .cpp load the glassydynamics.nc and kept runing.
...
int main(int argc, char*argv[])
{
    ...
    sprintf(saveDirName, "/scratch/bbtm/cli6/glassyDynamics/data/N%i/p%.3f/sac/",numpts,p0);
 
     
    sprintf(datanamePeri,"%sSACtime_perimeter_N%i_p%.4f_T%.8f_idx%i.nc",saveDirName,numpts,p0,T,recordIndex);
    sprintf(datanameArea,"%sSACtime_area_N%i_p%.4f_T%.8f_idx%i.nc",saveDirName,numpts,p0,T,recordIndex);
    shared_ptr<autocorrelator> acdatPeri = make_shared<autocorrelator>(16,2,dt);
    shared_ptr<autocorrelator> acdatArea = make_shared<autocorrelator>(16,2,dt);
