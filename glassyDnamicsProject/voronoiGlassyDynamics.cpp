...
int main(int argc, char*argv[])
{
    ...
    for(int ii = 0; ii < offsetsSAC.size(); ++ii)
        {
        sprintf(SACname,"%sSACtime_N%i_p%.4f_T%.8f_waitingTime%.6f_idx%i.nc",saveDirName,numpts,p0,T,offsetsSAC[ii]*dt,recordIndex);
        ...
        lsacwriter.addDatabase(SACtime,acdat,offsetsSAC[ii]);
        }
